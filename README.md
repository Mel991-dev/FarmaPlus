...
> Versión: 1.0.0 (MVP) · Estado actual: Parcialmente desarrollado (Núcleo funcional)  
> Programa: Análisis y Desarrollo de Software — SENA  
> Fecha estimada de entrega MVP: Mayo 2026
...
│       │   ├── logo.png
│       │   └── favicon.ico
│       └── uploads/                # Imágenes de productos (organizado por producto_id)
│           └── productos/
│
...
│   │   ├── ImagenProductoController.php # Gestión de carga y conversión de imágenes
...
│   │   ├── CategoriaModel.php
│   │   ├── AlertaModel.php
│   │   ├── ImagenProductoModel.php # Persistencia y reordenamiento de imágenes
...
git https://github.com/Mel991-dev/FarmaPlus.git
cd FarmaPlus
...
# Opción A (nativa):
npx tailwindcss -i ./public/assets/css/app.css -o ./public/assets/css/app.min.css --watch

# Opción B (recomendada via scripts de package.json):
npm run dev

# 7. Configuración del Servidor Web (DocumentRoot)
# Es CRÍTICO que el servidor apunte a la carpeta /public para que el ruteo funcione.

### Opción A: WampServer64
# Editar VirtualHost para que el DocumentRoot sea: C:/wamp64/www/FarmaPlus/public/

### Opción B: XAMPP
# 1. En el panel de XAMPP, clic en Config -> Apache (httpd.conf)
# 2. Cambiar DocumentRoot "C:/xampp/htdocs" por "C:/xampp/htdocs/FarmaPlus/public"
# 3. Cambiar <Directory "C:/xampp/htdocs"> por <Directory "C:/xampp/htdocs/FarmaPlus/public">
# 4. Reiniciar Apache.

### Opción C: Servidor integrado de PHP (Solo para pruebas rápidas)
...
_Proyecto académico — Desarrollado por aprendices del sena!!! >— SENA · 2026_
